function [R_rec,time1,time2]=fractalDCT16En(R,size1,Tp)
...
%     end
% end
dct_R =blkproc(R,[16 16],'P1*x*P2',T16,T16');
% dct_R =blkproc(dct_R,[16 16],'x.*P1',mask); 
...
dct_rec =blkproc(dct_R,[16 16],'P1*x*P2',T16',T16);
R_rec = uint8(0.35*frac_R+0.65*dct_rec+128);
% R_rec=uint8(dct_rec+128);
